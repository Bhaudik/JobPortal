...
<body data-instant-intensity="mousedown">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="ProfilePicFrom" name="ProfilePicFrom" method="post" enctype="multipart/form-data">
                        {{-- @csrf --}}
                        <div class="mb-3">
    ...
    <script>
        ...
        $('#ProfilePicFrom').submit(function(e) {
            e.preventDefault(); // Prevent the default form submission

            var formData = new FormData(this); // Correct the typo
            $.ajax({
                type: 'POST',
                url: "{{ route('update.profilepic') }}", // Ensure this matches your Laravel route
                data: formData,
                dataType: 'json',
                contentType: false,
                processData: false,
